...
select o.訂單號碼, pt.類別名稱, p.產品, od.單價, od.數量, round(od.單價*od.數量*(1-od.折扣),0)as 產品價錢小計,
cu.客戶編號, cu.公司名稱, o.收貨人, o.訂單日期, e.姓名, c.貨運公司名稱,s.供應商
from 訂單明細 as od inner join 訂單資料 as o on od.訂單號碼=o.訂單號碼
inner join 貨運公司 as c on o.送貨方式=c.貨運公司編號
...
where o.訂單日期 between '1996-07-01' and '1996-07-31' and c.貨運公司名稱='白貓宅急便'
